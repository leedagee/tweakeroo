...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_BEDROCK_REMOVAL           ("tweakBedrockRemoval",                 false, "",     "Helps break bedrock (or other blocks) with piston retract schedule tick.\nHold pickaxe that can instantly mine a piston (you may need haste effect) in main hand and piston on off hand.\nRight click on a extended piston will break neighbouring redstone torch and then the piston itself before placing a new piston.\n"),
    ...
    TWEAK_BOOK_DUPE                 ("tweakBookDupe",                       false, "",    "Duplicate your inventory via a UTF serialize bug\n(you will be kicked from server)"),
